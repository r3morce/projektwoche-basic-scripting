...
# Solche Key-Value-Paare können beispielsweise sein:
{
    ...
    "schulform": "Realschule", # "schulform" ist der Schlüssel, der Wert ist "Realschule"
...
# Die Information in einem Dictionary hängen meist logisch zusammen. Das Kantinengeld gehört zu diesem Schüler und nicht zu einem Anderen.

# Natürlich kann ein Dictionary (dict) auch geprinted werden
print(schuelerkartei_432)

# Wie bei einer Liste mit dem Index kann ich auf die Werte im Dictionary mit dem Schlüssel/Key zugreifen.
