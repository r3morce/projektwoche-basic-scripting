...
agent_infos = response["data"]

# TODO: Nutzt eine Schleife um jeden Agent Namen einzeln auszugeben
# In den Agent Infos befindet sich ein Fehler, den könnt ihr jetzt ignorieren, den beheben wir später.


# TODO: Gibt zusätzlich zu den Agent Namen auch ihren Namen während der Entwicklung aus